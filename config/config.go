...
type LocalFlags struct {
	...
	SystemPingNetworkInstance string        `json:"system-ping-network-instance,omitempty" mapstructure:"system-ping-network-instance,omitempty" yaml:"system-ping-network-instance,omitempty"`
	// System Traceroute
	...
	SystemTracerouteNetworkInstance string        `json:"system-traceroute-network-instance,omitempty" mapstructure:"system-traceroute-network-instance,omitempty" yaml:"system-traceroute-network-instance,omitempty"`
	// System Reboot
	...
	ContainerzVolumeCreateOptions string   `json:"containerz-volume-create-options,omitempty" mapstructure:"containerz-volume-create-options,omitempty" yaml:"containerz-volume-create-options,omitempty"`
